...
def bbox_ious(boxes1, boxes2):
    """Compute IoU between sets of bounding boxes."""
    area1 = (boxes1[:, 2] - boxes1[:, 0]) * (boxes1[:, 3] - boxes1[:, 1])
    area2 = (boxes2[:, 2] - boxes2[:, 0]) * (boxes2[:, 3] - boxes2[:, 1])

    xi1 = np.maximum(boxes1[:, None, 0], boxes2[:, 0])
    yi1 = np.maximum(boxes1[:, None, 1], boxes2[:, 1])
    xi2 = np.minimum(boxes1[:, None, 2], boxes2[:, 2])
    yi2 = np.minimum(boxes1[:, None, 3], boxes2[:, 3])
